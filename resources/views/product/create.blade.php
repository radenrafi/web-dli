...
<main class="container">
    ...
    <form action="{{ url('admin/product') }}" method="POST" enctype="multipart/form-data" class="form">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('desc') is-invalid @enderror" name="desc" id="desc" value="{{old('desc')}}">
            @error('desc')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('baseline') is-invalid @enderror" name="baseline" id="baseline" value="{{old('baseline')}}">
            @error('baseline')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('target1') is-invalid @enderror" name="target1" id="target1" value="{{old('target1')}}">
            @error('target1')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('target2') is-invalid @enderror" name="target2" id="target2" value="{{old('target2')}}">
            @error('target2')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('target3') is-invalid @enderror" name="target3" id="target3" value="{{old('target3')}}">
            @error('target3')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
